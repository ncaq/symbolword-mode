...
;;   (cond ((equal-syntax-and-unicode str (get-str-from-buffer))
...
(defun sub-kill-symbolword (startstr)
  ())

(defun kill-symbolword ()
  (interactive)
  (sub-kill-symbolword (get-str-from-buffer)))

(defun backward-kill-symbolword-sub (str)
  (cond ((equal-syntax-and-unicode str (get-str-from-buffer-backward))
